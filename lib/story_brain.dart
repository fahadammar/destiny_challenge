...
class StoryBrain {
  ...
  // todo 23 - Use the _storyNumber property inside getStory(), getChoice1() and //// getChoice2() so that it gets the updated story and choices rather than //////// always just the first (0th) one.
  // todo 8: getStory() method
  getStory() {
    return this._storyData[_storyNumber].storyTitle;
  }

  // todo 11: getChoice1() method
  getChoice1() {
    return this._storyData[_storyNumber].choice1;
  }

  // todo 12: getChoice2() method
  getChoice2() {
    return this._storyData[_storyNumber].choice2;
  }

  // todo 17: nextStory() - todo 21
  nextStory(int choiceNumber) {
    ...
    /* TODO 22 - In nextStory() if the _storyNumber is equal to 3 or 4 or 5, that means it's the end of the game and it should call a method called restart() that resets the _storyNumber to 0.*/
